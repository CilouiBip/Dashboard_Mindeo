...
const questionnaireTables = [
  {
    ...
    fields: [
      ...
      { name: 'Score_Min_Acceptable', type: 'number', options: { precision: 1 } },
      { name: 'Score_Max_Possible', type: 'number', options: { precision: 1 } }
    ]
  },
  {
    name: 'Questions',
  ...
  },
  {
    ...
    fields: [
      { name: 'Questionnaire_ID', type: 'singleLineText' },
      { name: 'Date_Début', type: 'dateTime', options: { dateFormat: { name: 'iso', format: 'YYYY-MM-DD' }, timeFormat: { name: '24hour', format: 'HH:mm' } } },
      { name: 'Date_Fin', type: 'dateTime', options: { dateFormat: { name: 'iso', format: 'YYYY-MM-DD' }, timeFormat: { name: '24hour', format: 'HH:mm' } } },
      { name: 'Statut', type: 'singleSelect', options: { choices: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'Timestamp', type: 'dateTime', options: { dateFormat: { name: 'iso', format: 'YYYY-MM-DD' }, timeFormat: { name: '24hour', format: 'HH:mm' } } }
    ]
  }
];
...
const dueDiligenceTables = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'Date_Upload', type: 'dateTime', options: { dateFormat: { name: 'iso', format: 'YYYY-MM-DD' }, timeFormat: { name: '24hour', format: 'HH:mm' } } },
